...
describe("AppointmentController", () => {
  ...
  describe("CreateAppointment", () => {
    ...
    it("should return 409 if timeslot quota is full", async () => {
      ...
      const fakeTimeslot = { id: 1, slotTersedia: 0, Schedule: { Doctor: {} } };
    ...
    it("should create appointment if timeslot is found and quota is available", async () => {
      ...
      expect(fakeTimeslot.set).toHaveBeenCalledWith({ slotTersedia: 0 });
      expect(fakeTimeslot.save).toHaveBeenCalledWith({ transaction: t });
